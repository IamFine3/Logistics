		...
		<td><table width="786" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<th width="597" height="31" align="center"><a href="${APP_PATH }/jsp/pageHome.jsp"
						...
						class="a1">物流动态</a>&nbsp;|&nbsp;<a href="${APP_PATH }/jsp/knowledge_select.jsp"
						class="a1">物流知识</a>&nbsp;|&nbsp;<a href="${APP_PATH }/jsp/goods_select.jsp"
						class="a1">货物信息</a>&nbsp;|&nbsp;<a href="${APP_PATH }/jsp/car_select.jsp"
						class="a1">车辆信息</a>&nbsp;|&nbsp;<a href="${APP_PATH }/jsp/enterprise_select.jsp"
						class="a1">企业信息</a>&nbsp;|&nbsp;<a href="${APP_PATH }/jsp/register.jsp"
...
<table width="100%" height="115" border="0" cellpadding="0"
	cellspacing="0" background="image/5.jpg">
	<tr>
		<td valign="top"><table width="787" height="151" border="0"
