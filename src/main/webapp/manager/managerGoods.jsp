	...
	<div class="page">
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">货物信息</h4>
									</div>
									<div class="modal-body">
										...
										<form class="form-horizontal" id="formLogistics">
											...
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">货物类型</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="goodsstyle"
														name="goodsstyle" placeholder="goodsstyle...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">货物名称</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="goodsname"
														name="goodsname" placeholder="goodsname...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">货物数量</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="goodsnumber"
														name="goodsnumber" placeholder="goodsnumber...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">数量单位</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="goodsunit"
														name="goodsunit" placeholder="goodsunit...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">起始省份</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="startprovince"
														name="startprovince" placeholder="startprovince...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">起始城市</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="startcity"
														name="startcity" placeholder="startcity...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">抵达省份</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="endprovince"
														name="endprovince" placeholder="endprovince...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">抵达城市</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="endcity"
														name="endcity" placeholder="endcity...">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
											...
											<div class="form-group">
												<label for="UserName_add_input"
													class="col-sm-2 control-label">运输时间</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="transporttime"
														name="transporttime" placeholder="yyyy-MM-dd">
												</div>
											</div>
											<div class="form-group">
												<label for="UserName_add_input"
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<textarea name="remark" id="remark" class="form-control"
														cols="10" rows="3" placeholder="在这里输入内容..."></textarea>
												</div>
											</div>
											<div class="form-group">
												<label for="Password_add_input"
													class="col-sm-2 control-label">运输要求</label>
												<div class="col-sm-10">
		...
		<script type="text/javascript">
				...
				$.each(records,
						function(index, item) {
							...
							var userNameTd = $("<td></td>").append(
									item.goodsname);
							var goodsnumberTd = $("<td></td>").append(
									item.goodsnumber);
							var goodsunitTd = $("<td></td>").append(
									item.goodsunit);
							...
							$("<tr></tr>").append(userIdTd).append(userNameTd)
									.append(goodsnumberTd).append(goodsunitTd)
									.append(startprovinceTd).append(
											endprovinceTd).append(
											transporttimeTd).append(phoneTd)
									.append(linkTd).append(btnTd).appendTo(
											"#records_table tbody");
						});
			}
			...
			function editRecord(index) {
				...
				$('#recordAddModal input[name=goodsstyle]').val(item.goodsstyle);
				$('#recordAddModal input[name=goodsname]').val(item.goodsname);
				$('#recordAddModal input[name=goodsnumber]').val(item.goodsnumber);
				$('#recordAddModal input[name=goodsunit]').val(item.goodsunit);
				$('#recordAddModal input[name=startprovince]').val(item.startprovince);
				$('#recordAddModal input[name=startcity]').val(item.startcity);
				$('#recordAddModal input[name=endprovince]').val(item.endprovince);
				$('#recordAddModal input[name=endcity]').val(item.endcity);
				$('#recordAddModal input[name=style]').val(item.style);
				$('#recordAddModal input[name=transporttime]').val(item.transporttime);
				$('#recordAddModal input[name=phone]').val(item.phone);
				$('#recordAddModal input[name=link]').val(item.link);
				$('#recordAddModal input[name=phone]').val(item.phone);
				$('#recordAddModal textarea[name=remark]').val(item.remark);
				$('#recordAddModal textarea[name=request]').val(item.request);
