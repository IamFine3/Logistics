		...
		<div class="bgh">
			<div class="page">
				...
				<div class="topxx">
					...
					<%=username%>&nbsp;欢迎您！<a
						href="/OneCard/LogOutServlet">安全退出</a>
				</div>
	...
	<div class="page">
		<div class="box mtop">
			...
			<div class="rightbox">
				...
				<h2 class="mbx">会员管理 &gt; 管理会员</h2>
				<div class="morebt">
					<ul>
						<li><a class="tab1"
							href="${APP_PATH }/manager/managerUser.jsp">管理会员</a></li>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form class="form-horizontal" id="formUser">
											...
											<div class="form-group" id="Gender_add_input">
		...
		<script type="text/javascript">
				...
				$.each(users,
						function(index, item) {
							...
							$("<tr></tr>").append(userIdTd).append(userNameTd)
									.append(genderTd).append(phoneTd).append(
			...
			$("#add_save_btn").click(function() {
				...
				$.ajax({
					...
					success : function(result) {
						//用户保存成功
						if (result.extend.managerUser > 0) {
							//1.关闭模态框
